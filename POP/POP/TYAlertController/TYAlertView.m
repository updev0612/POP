...
- (void)configureProperty
{
    ...
    _buttonCornerRadius = 10.0;
    _buttonFont = [UIFont fontWithName:@"Lato-Regular" size:15];
//    _buttonDefaultBgColor = [UIColor colorWithRed:52/255.0 green:152/255.0 blue:219/255.0 alpha:1];
    _buttonDefaultBgColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:1];
    ...
    _textFieldFont = [UIFont systemFontOfSize:10];
...
- (void)addTextLabels
{
    ...
    titleLabel.font = [UIFont fontWithName:@"Lato-Bold" size:17];
    ...
    messageLabel.font = [UIFont fontWithName:@"Lato-Regular" size:15];
...
- (void)addAction:(TYAlertAction *)action
{
    ...
    if ([action.title isEqualToString:@"Cancel"]) {
        ...
        [button setImage:[UIImage imageNamed:@"Cross Icon"] forState:UIControlStateNormal];
        ...
        [[button.rightAnchor constraintEqualToAnchor:self.rightAnchor constant:0] setActive:YES];
        [[button.widthAnchor constraintEqualToConstant:36] setActive:YES];
        [[button.heightAnchor constraintEqualToConstant:36] setActive:YES];
...
//        [button setUserInteractionEnabled:YES];
        ...
        button.layer.borderColor = [UIColor colorWithRed:221/255.0 green:221/255.0 blue:221/255.0 alpha:1.0].CGColor;
        button.backgroundColor = [self buttonBgColorWithStyle:action.style];
        [button setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
        [_buttons addObject:button];
        [_buttonContentView addSubview:button];
        button.tag = kButtonTagOffset + _buttons.count - 1;
    }
...
- (void)layoutContentViews
{
    ...
    [imgView setImage:[UIImage imageNamed:@"Setting_BG"]];
