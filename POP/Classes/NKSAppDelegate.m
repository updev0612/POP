...
#   define CONSUMER_KEY     @"N2JjODRiZTMtYzMzOS00OWY1LWI5NDEtMTVmZGExM2ZiYmNl"
#   define CONSUMER_SECRET  @"NTAzNmJkZmEtODZmYi00NTcwLThlZjctMDM0NjVjNGYzM2Ix"

#   define BASE_URL @"FirstNapsterMusicApp://authorize"

#define SIGN_URL  @"https://us.napster.com/pricing"

NSString* const NKSFavoritesPlaylistName = @"Sample App Favorites";

@interface NKSAppDelegate () <NSURLSessionDelegate, UIAlertViewDelegate>
